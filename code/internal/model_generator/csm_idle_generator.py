...
print('ts cid PCI last_cid EARFCN last_freq sib5_freq in_sib5_freq_get_qmin in_sib5_freq_get_threshq sib3 in_sib3_freq_get_threshq sib3_priority ' + \
	'priority op TAC tac cid_256 qual_high qual_low highest_pri higher_serv')
